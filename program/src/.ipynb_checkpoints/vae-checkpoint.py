...
class VAE(nn.Module):
    def __init__(self, input_dim, input_dim_target,  n_latent, n_hidden=50, alpha=0.2):
        ...
        self.dense_enc1 = nn.Linear(self.input_dim, self.n_hidden)
        ...
        self.dense_dec0 = nn.Linear(self.n_latent, self.n_hidden, bias = False)
    ...
    def forward(self, X_in):
        ...
        sample_z, mn, sd = self.encoder(X_in)
